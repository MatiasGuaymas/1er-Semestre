...
ingresar el año 2020, que no debe procesarse, e informe la cantidad de casamientos realizados durante los meses de verano (enero, febrero y marzo) y 
...
type
	rangoDias= 1..31;
	rangoMes= 1..12;
	casamientos= record					// INCISO A, registro de casamientos
		dia: rangoDias;
		mes: rangoMes;
		ano: integer;
		end;
procedure cargarFecha (var fechas: casamientos);		// INCISO B
begin
	write('Ingresar dia: ');
	readln(fechas.dia);
	write('Ingresar mes: ');
...
Begin
	...
	writeln('La cantidad de casamientos en 2019 es: ',r2019);		// INCISO C
